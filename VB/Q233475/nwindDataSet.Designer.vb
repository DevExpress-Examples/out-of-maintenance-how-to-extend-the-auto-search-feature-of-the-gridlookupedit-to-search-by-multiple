...
Namespace Q233475
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class CategoriesDataTable
			...
			Public Function AddCategoriesRow(ByVal CategoryName As String) As CategoriesRow
				...
				Dim columnValuesArray() As Object = { Nothing, CategoryName}
		...
		Partial Public Class ProductsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddProductsRow(ByVal ProductName As String, ByVal parentCategoriesRowByCategoriesProducts As CategoriesRow) As ProductsRow
				Dim rowProductsRow As ProductsRow = (CType(Me.NewRow(), ProductsRow))
				Dim columnValuesArray() As Object = { Nothing, ProductName, Nothing}
	...
	End Class
End Namespace
Namespace Q233475.nwindDataSetTableAdapters
	...
	Partial Public Class CategoriesTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Categories` SET `CategoryName` = ? WHERE ((`CategoryID` = ?) AND ((? = 1 " & "AND `CategoryName` IS NULL) OR (`CategoryName` = ?)))"
		...
		Public Overridable Function Insert(ByVal CategoryName As String) As Integer
		...
		Public Overridable Function Update(ByVal CategoryName As String, ByVal Original_CategoryID As Integer, ByVal Original_CategoryName As String) As Integer
			If (CategoryName Is Nothing) Then
				Throw New Global.System.ArgumentNullException("CategoryName")
			Else
				Me.Adapter.UpdateCommand.Parameters(0).Value = (CStr(CategoryName))
			End If
			Me.Adapter.UpdateCommand.Parameters(1).Value = (CInt(Fix(Original_CategoryID)))
			If (Original_CategoryName Is Nothing) Then
				Throw New Global.System.ArgumentNullException("Original_CategoryName")
			Else
	...
	Partial Public Class ProductsTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand = New Global.System.Data.OleDb.OleDbCommand()
			Me._adapter.DeleteCommand.Connection = Me.Connection
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Products` WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS " & "NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `CategoryID` IS NULL) OR (`Categor" & "yID` = ?)))"
			Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
			...
			Me._adapter.UpdateCommand = New Global.System.Data.OleDb.OleDbCommand()
			Me._adapter.UpdateCommand.Connection = Me.Connection
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Products` SET `ProductName` = ?, `CategoryID` = ? WHERE ((`ProductID` = ?" & ") AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND" & " `CategoryID` IS NULL) OR (`CategoryID` = ?)))"
			Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(0).Connection = Me.Connection
			Me._commandCollection(0).CommandText = "SELECT ProductID, ProductName, CategoryID FROM Products"
			Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
		End Sub
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, True)> _
		Public Overridable Function Delete(ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_CategoryID As Global.System.Nullable(Of Integer)) As Integer
			...
			If (Original_CategoryID.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(4).Value = (CInt(Fix(Original_CategoryID.Value)))
			Else
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)> _
		Public Overridable Function Update(ByVal ProductName As String, ByVal CategoryID As Global.System.Nullable(Of Integer), ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_CategoryID As Global.System.Nullable(Of Integer)) As Integer
			...
			If (CategoryID.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(1).Value = (CInt(Fix(CategoryID.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(1).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.UpdateCommand.Parameters(2).Value = (CInt(Fix(Original_ProductID)))
			If (Original_ProductName Is Nothing) Then
				Throw New Global.System.ArgumentNullException("Original_ProductName")
			Else
				Me.Adapter.UpdateCommand.Parameters(3).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(4).Value = (CStr(Original_ProductName))
			End If
			If (Original_CategoryID.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(5).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(6).Value = (CInt(Fix(Original_CategoryID.Value)))
			Else
